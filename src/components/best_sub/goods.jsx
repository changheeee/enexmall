            ...
            <div className="product_list">
                ...
                <div className="list_in">
                    ...
                    <ul className="product_toggle">
                        <li>{item.timesale && <img src='/images/toggle/toggle_time.gif' />}</li>
                ...
                <ul className="product_tit">
                    ...
                    <li style={{ display: 'flex' }}>
                        {item.timesale && <img src="/images/toggle/timetoggle.png" className="timesale_ico" />}
                        <h4>{item.discount}</h4>
                        <h5>{item.dcprice}</h5>
                        <b>{item.price}</b>
                    </li>
    ...
    if (87 <= item.id && item.id <= 90) {
        return (
            <div className="new_list" style={{ marginTop: '40px' }}>
                ...
                <div className="list_in">
                    <div className="favorite_toggle"></div>
                    <SoldOut item={item} key={item.id} />
                ...
                <ul className="new_tit">
                    ...
                    <li>
                        <dd>모델번호:{item.model}</dd>
                        <dd>상품코드:{item.code}</dd>
                    </li>
                </ul>
            </div>
        )
